...
| 对话归档 | [modules/conversation_archive.md](modules/conversation_archive.md) | `src/openbiliclaw/conversation_archive/` + `api/conversation_archive_routes.py` | ✅ v0.3.246 单表 + FTS5 trigram 全文检索 + 桌面 `/web/conversation-archive` 与移动端 tab（v0.3.242 编号被阅读库补抓占用，changelog 记为 v0.3.246 补记） |
