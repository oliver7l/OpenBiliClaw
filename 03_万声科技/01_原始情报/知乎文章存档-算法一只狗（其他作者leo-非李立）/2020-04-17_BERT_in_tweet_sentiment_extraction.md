...
- 链接: https://zhuanlan.zhihu.com/p/132400462
- 发布: 2020-04-17 11:02:47
- 赞同: 1 | 评论: 1
...
**我自己实现的项目实现代码在：** [https://github.com/llq20133100095/tweet_sentiment_extraction](https://github.com/llq20133100095/tweet_sentiment_extraction)
...
![](https://pic4.zhimg.com/v2-d02f6a83faae0b71bef1cfc5f297b3e1_1440w.jpg)
...
- bert_pretrain_model: BERT模型下载到这里，并进行解压。具体模型下载连接： [https://github.com/google-research/bert](https://github.com/google-research/bert)
...
主要实现在 [run_classifier_custom.py](https://github.com/llq20133100095/tweet_sentiment_extraction/blob/master/run_classifier_custom.py)
...
模型评估需要重新恢复构建的词语，代码在 [train.py](https://github.com/llq20133100095/tweet_sentiment_extraction/blob/master/train.py)
...
最后会生成可以提交的csv文件： [submission.csv](https://github.com/llq20133100095/tweet_sentiment_extraction/blob/master/input_data/submission.csv)

形式如下：

![](https://pic2.zhimg.com/v2-1eacc1ed3940a276a32363a203050707_1440w.jpg)