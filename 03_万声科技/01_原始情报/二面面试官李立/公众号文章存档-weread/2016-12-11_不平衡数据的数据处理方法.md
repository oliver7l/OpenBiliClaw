...
- 链接: https://mp.weixin.qq.com/s/ux0N_kcRHW-n1sJ4_BgMfA
- 发布: 2016-12-11
...
![](http://mmbiz.qpic.cn/mmbiz_png/Q3H1TCddfvN2giaCm3q5B4uzgiciblLNLa69u40MorBiaBkaDmicia15D7D10EcAIH1Sx7bdYNakySecXEZhOJQn5JxA/0?wx_fmt=png)
...
![](http://mmbiz.qpic.cn/mmbiz_png/Q3H1TCddfvN2giaCm3q5B4uzgiciblLNLa6s6Gpm2BstseZWtnGH9FSJpWDbBZfk8amxwx1JBVmB4JrOnUib91D2pQ/0?wx_fmt=png)

改进的过抽样方法则采用加入随机高斯噪声或产生新的合成样本等方法。根据不同的数据类型，我们可以设计很巧妙的过抽样方法。有博客 在识别交通信号问题上就提出了一个新颖的方法。交通信号处理识别是输入交通信号的图片，输出交通信号。我们可以通过变换交通信号图片的角度等方法，生成新的交通信号图片，如下所示。

![](http://mmbiz.qpic.cn/mmbiz_png/Q3H1TCddfvN2giaCm3q5B4uzgiciblLNLa6kQK4JIhC9rPy4mSzvica2EWfXfJ3a1h4ictL94OTPlTKjzIb92CJ1s0A/0?wx_fmt=png)
...
![](http://mmbiz.qpic.cn/mmbiz_png/Q3H1TCddfvN2giaCm3q5B4uzgiciblLNLa6l89SjbURdFXL5iakZP04CRZMQFYFxT57j3oVClTAT93MV6wTGhiapqXA/0?wx_fmt=png)
