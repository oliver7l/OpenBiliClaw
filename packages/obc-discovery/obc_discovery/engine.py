...
class ContentDiscoveryEngine:
    ...
    async def evaluate_content(
        ...
        *,
        ...
        from obc_llm.prompts import build_content_evaluation_prompt
    ...
    async def _evaluate_batch(
        ...
        *,
        ...
        if (
            ...
            from obc_discovery import multimodal
    ...
    def infer_style_key(
        *,
        ...
        from obc_discovery.style_rules import infer_style_key as _infer
