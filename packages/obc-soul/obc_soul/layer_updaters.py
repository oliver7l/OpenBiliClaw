...
async def _update_role(
    ...
    **_: Any,
    ...
    from obc_llm.prompts import build_role_delta_prompt
...
async def _update_values(
    ...
    **_: Any,
    ...
    from obc_llm.prompts import build_values_delta_prompt
...
async def _update_core(
    ...
    **_: Any,
    ...
    from obc_llm.prompts import build_core_delta_prompt
